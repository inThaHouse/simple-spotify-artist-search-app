...
export const SPOTIFY_AUTH_ROUTE = `${AUTH_END_POINT}?client_id=${CLIENT_ID}&redirect_uri=${REDIRECT_URI}&scope=user-read-private&response_type=token&state=${AUTH_SUCCESS_STATE}`
